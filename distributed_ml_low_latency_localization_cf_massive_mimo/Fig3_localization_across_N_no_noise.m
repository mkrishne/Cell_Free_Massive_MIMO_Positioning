rng(8);
diary Fig3b_localization_across_N_no_noise_diary;
...
avg_positioning_err_centr_rss_no_noise = zeros(1,N_max);
avg_positioning_err_centr_aoa_no_noise = zeros(1,N_max);
avg_positioning_err_centr_hybrid_no_noise = zeros(1,N_max);
avg_positioning_err_distr_median_no_noise = zeros(1,N_max);
avg_positioning_err_distr_mean_no_noise = zeros(1,N_max);
avg_positioning_err_distr_bayesian_no_noise = zeros(1,N_max);
avg_positioning_err_distr_zscore_tz_1_no_noise = zeros(1,N_max);
avg_positioning_err_distr_zscore_tz_1_bayesian_no_noise = zeros(1,N_max);

%-----------------------------------------------------------
avg_err_ellipse_area_centr_rss_no_noise = zeros(1,N_max);
avg_err_ellipse_area_centr_aoa_no_noise = zeros(1,N_max);
avg_err_ellipse_area_centr_hybrid_no_noise = zeros(1,N_max);
avg_err_ellipse_area_distr_median_no_noise = zeros(1,N_max);
avg_err_ellipse_area_distr_mean_no_noise = zeros(1,N_max);
avg_err_ellipse_area_distr_bayesian_no_noise = zeros(1,N_max);
avg_err_ellipse_area_distr_zscore_tz_1_no_noise = zeros(1,N_max);
avg_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise = zeros(1,N_max);
%-----------------------------------------------------------
per_setup_positioning_err_centr_rss_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_centr_aoa_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_centr_hybrid_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_distr_median_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_distr_mean_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_distr_bayesian_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_distr_zscore_tz_1_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_positioning_err_distr_zscore_tz_1_bayesian_no_noise = zeros(nbrOfSetups,num_tp_points);
%-----------------------------------------------------------
per_setup_err_ellipse_area_centr_rss_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_centr_aoa_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_centr_hybrid_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_distr_median_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_distr_mean_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_distr_bayesian_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_distr_zscore_tz_1_no_noise = zeros(nbrOfSetups,num_tp_points);
per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise = zeros(nbrOfSetups,num_tp_points);
%-----------------------------------------------------------
% Initialize cell arrays to store setups and shadowing data
% Shadowing is still computed in the offline phase to ensure correlated shadowing in the online phase.
% The rng in line 1 ensures that shadowing values match those used in the noisy version of the script.
...
for n_idx = 1:N_max
    ...
    for setup_idx = 1:nbrOfSetups
        ...
        for RP_idx = 1:K
            ...
            for AP_idx = 1:L
                ...
                nom_azi_angle_fngprnt(RP_idx,AP_idx) = nom_azi_angle; %azimuth is angle between UE and BS on x axis
    ...
    centr_rss_gpr_x_model = fitrgp(centr_rss_gpr_X,"x_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    centr_rss_gpr_Y = array2table([RSS_fngprnt_dB,y_coordinates],"VariableNames",[RSS_var_names "y_coordinates"]);
    centr_rss_gpr_y_model = fitrgp(centr_rss_gpr_Y,"y_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);

    centr_aoa_gpr_X = array2table([nom_azi_angle_fngprnt,x_coordinates],"VariableNames",[AoA_var_names "x_coordinates"]);
    centr_aoa_gpr_x_model = fitrgp(centr_aoa_gpr_X,"x_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    centr_aoa_gpr_Y = array2table([nom_azi_angle_fngprnt,y_coordinates],"VariableNames",[AoA_var_names "y_coordinates"]);
    centr_aoa_gpr_y_model = fitrgp(centr_aoa_gpr_Y,"y_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    
    centr_hybrid_gpr_X = array2table([RSS_fngprnt_dB,nom_azi_angle_fngprnt,x_coordinates],"VariableNames",var_names_x);
    centr_hybrid_gpr_x_model = fitrgp(centr_hybrid_gpr_X,"x_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    centr_hybrid_gpr_Y = array2table([RSS_fngprnt_dB,nom_azi_angle_fngprnt,y_coordinates],"VariableNames",var_names_y);
    centr_hybrid_gpr_y_model = fitrgp(centr_hybrid_gpr_Y,"y_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    ...
    for AP_idx = 1:L
        ...
        variable.(dyn_var_name_x) = fitrgp(distr_gpr_X,"x_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
        distr_gpr_Y = table(per_AP_RSS_fngprnt,per_AP_AoA_fngprnt,y_coordinates);
        variable.(dyn_var_name_y) = fitrgp(distr_gpr_Y,"y_coordinates",'kernelfunction',kernel_function,'Sigma',0.0001,'ConstantSigma',true,'SigmaLowerBound',0.00001);
    ...
    for TP_idx = 1:num_tp_points 
        ...
        per_setup_positioning_err_centr_rss_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        per_setup_err_ellipse_area_centr_rss_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_sd*y_coordinate_sd;
        ...
        per_setup_positioning_err_centr_aoa_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        per_setup_err_ellipse_area_centr_aoa_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_sd*y_coordinate_sd;
        ...
        per_setup_positioning_err_centr_hybrid_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        per_setup_err_ellipse_area_centr_hybrid_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_sd*y_coordinate_sd;
        ...
        per_setup_positioning_err_distr_median_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        ...
        per_setup_err_ellipse_area_distr_median_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_median_sd*y_coordinate_median_sd;
        ...
        per_setup_positioning_err_distr_mean_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');

        x_coordinate_mean_sd = sqrt(sum(DISTR_PRED_TP_X_COORDS_SD.^2))/L;
        y_coordinate_mean_sd = sqrt(sum(DISTR_PRED_TP_X_COORDS_SD.^2))/L;
        per_setup_err_ellipse_area_distr_mean_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_mean_sd*y_coordinate_mean_sd;
        ...
        per_setup_positioning_err_distr_zscore_tz_1_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        ...
        per_setup_err_ellipse_area_distr_zscore_tz_1_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_zscore_mean_sd*y_coordinate_zscore_mean_sd;
        ...
        per_setup_positioning_err_distr_bayesian_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        per_setup_err_ellipse_area_distr_bayesian_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_bayesian_sd*y_coordinate_bayesian_sd;
        ...
        per_setup_positioning_err_distr_zscore_tz_1_bayesian_no_noise(setup_idx,TP_idx) = pdist(dist_coords,'euclidean');
        per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise(setup_idx,TP_idx) = 5.991*pi*x_coordinate_zscore_bayesian_sd*y_coordinate_zscore_bayesian_sd;
...
avg_positioning_err_centr_rss_no_noise(n_idx) = mean(per_setup_positioning_err_centr_rss_no_noise(~isnan(per_setup_positioning_err_centr_rss_no_noise) & ~isinf(per_setup_positioning_err_centr_rss_no_noise)));
avg_positioning_err_centr_aoa_no_noise(n_idx) = mean(per_setup_positioning_err_centr_aoa_no_noise(~isnan(per_setup_positioning_err_centr_aoa_no_noise) & ~isinf(per_setup_positioning_err_centr_aoa_no_noise)));
avg_positioning_err_centr_hybrid_no_noise(n_idx) = mean(per_setup_positioning_err_centr_hybrid_no_noise(~isnan(per_setup_positioning_err_centr_hybrid_no_noise) & ~isinf(per_setup_positioning_err_centr_hybrid_no_noise)));

% Average positioning errors for distributed approaches
avg_positioning_err_distr_median_no_noise(n_idx) = mean(per_setup_positioning_err_distr_median_no_noise(~isnan(per_setup_positioning_err_distr_median_no_noise) & ~isinf(per_setup_positioning_err_distr_median_no_noise)));
avg_positioning_err_distr_mean_no_noise(n_idx) = mean(per_setup_positioning_err_distr_mean_no_noise(~isnan(per_setup_positioning_err_distr_mean_no_noise) & ~isinf(per_setup_positioning_err_distr_mean_no_noise)));
avg_positioning_err_distr_zscore_tz_1_no_noise(n_idx) = mean(per_setup_positioning_err_distr_zscore_tz_1_no_noise(~isnan(per_setup_positioning_err_distr_zscore_tz_1_no_noise) & ~isinf(per_setup_positioning_err_distr_zscore_tz_1_no_noise)));
avg_positioning_err_distr_bayesian_no_noise(n_idx) = mean(per_setup_positioning_err_distr_bayesian_no_noise(~isnan(per_setup_positioning_err_distr_bayesian_no_noise) & ~isinf(per_setup_positioning_err_distr_bayesian_no_noise)));
avg_positioning_err_distr_zscore_tz_1_bayesian_no_noise(n_idx) = mean(per_setup_positioning_err_distr_zscore_tz_1_bayesian_no_noise(~isnan(per_setup_positioning_err_distr_zscore_tz_1_bayesian_no_noise) & ~isinf(per_setup_positioning_err_distr_zscore_tz_1_bayesian_no_noise)));

% Average error ellipse area for centralized approaches
avg_err_ellipse_area_centr_rss_no_noise(n_idx) = mean(per_setup_err_ellipse_area_centr_rss_no_noise(~isnan(per_setup_err_ellipse_area_centr_rss_no_noise) & ~isinf(per_setup_err_ellipse_area_centr_rss_no_noise)));
avg_err_ellipse_area_centr_aoa_no_noise(n_idx) = mean(per_setup_err_ellipse_area_centr_aoa_no_noise(~isnan(per_setup_err_ellipse_area_centr_aoa_no_noise) & ~isinf(per_setup_err_ellipse_area_centr_aoa_no_noise)));
avg_err_ellipse_area_centr_hybrid_no_noise(n_idx) = mean(per_setup_err_ellipse_area_centr_hybrid_no_noise(~isnan(per_setup_err_ellipse_area_centr_hybrid_no_noise) & ~isinf(per_setup_err_ellipse_area_centr_hybrid_no_noise)));

% Average error ellipse area for distributed approaches
avg_err_ellipse_area_distr_median_no_noise(n_idx) = mean(per_setup_err_ellipse_area_distr_median_no_noise(~isnan(per_setup_err_ellipse_area_distr_median_no_noise) & ~isinf(per_setup_err_ellipse_area_distr_median_no_noise)));
avg_err_ellipse_area_distr_mean_no_noise(n_idx) = mean(per_setup_err_ellipse_area_distr_mean_no_noise(~isnan(per_setup_err_ellipse_area_distr_mean_no_noise) & ~isinf(per_setup_err_ellipse_area_distr_mean_no_noise)));
avg_err_ellipse_area_distr_zscore_tz_1_no_noise(n_idx) = mean(per_setup_err_ellipse_area_distr_zscore_tz_1_no_noise(~isnan(per_setup_err_ellipse_area_distr_zscore_tz_1_no_noise) & ~isinf(per_setup_err_ellipse_area_distr_zscore_tz_1_no_noise)));
avg_err_ellipse_area_distr_bayesian_no_noise(n_idx) = mean(per_setup_err_ellipse_area_distr_bayesian_no_noise(~isnan(per_setup_err_ellipse_area_distr_bayesian_no_noise) & ~isinf(per_setup_err_ellipse_area_distr_bayesian_no_noise)));
avg_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise(n_idx) = mean(per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise(~isnan(per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise) & ~isinf(per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise)));

% Print average positioning errors
fprintf('\nAverage Positioning Errors:\n');

% Centralized Positioning Errors
fprintf('C-RSS no_noise: %.4f\n', avg_positioning_err_centr_rss_no_noise(n_idx));
fprintf('C-AOA no_noise: %.4f\n', avg_positioning_err_centr_aoa_no_noise(n_idx));
fprintf('C-Hybrid no_noise: %.4f\n', avg_positioning_err_centr_hybrid_no_noise(n_idx));

% Distributed Positioning Errors
fprintf('D-Median no_noise: %.4f\n', avg_positioning_err_distr_median_no_noise(n_idx));
fprintf('D-Mean no_noise: %.4f\n', avg_positioning_err_distr_mean_no_noise(n_idx));
fprintf('D-ZS TZ 1 no_noise: %.4f\n', avg_positioning_err_distr_zscore_tz_1_no_noise(n_idx));
fprintf('D-BAY no_noise: %.4f\n', avg_positioning_err_distr_bayesian_no_noise(n_idx));
fprintf('D-ZS-BAY TZ 1 no_noise: %.4f\n', avg_positioning_err_distr_zscore_tz_1_bayesian_no_noise(n_idx));

% Print average error ellipse areas
fprintf('\nAverage Error Ellipse Areas:\n');
fprintf('C-RSS no_noise: %.4f\n', avg_err_ellipse_area_centr_rss_no_noise(n_idx));
fprintf('C-AOA no_noise: %.4f\n', avg_err_ellipse_area_centr_aoa_no_noise(n_idx));
fprintf('C-Hybrid no_noise: %.4f\n', avg_err_ellipse_area_centr_hybrid_no_noise(n_idx));
fprintf('D-Median no_noise: %.4f\n', avg_err_ellipse_area_distr_median_no_noise(n_idx));
fprintf('D-Mean no_noise: %.4f\n', avg_err_ellipse_area_distr_mean_no_noise(n_idx));
fprintf('D-ZS TZ 1 no_noise: %.4f\n', avg_err_ellipse_area_distr_zscore_tz_1_no_noise(n_idx));
fprintf('D-BAY no_noise: %.4f\n', avg_err_ellipse_area_distr_bayesian_no_noise(n_idx));
fprintf('D-ZS-BAY TZ 1 no_noise: %.4f\n', avg_err_ellipse_area_distr_zscore_tz_1_bayesian_no_noise(n_idx));
