rng(1);
diary Fig8_localization_across_L_diary;
noiseVariancedBm = -96;
...
lambda = 3e8/fc;
N = 25
NUM_APs_IN_SIM_AREA = [5,10,15,20,25,30,35,40];
L_max = length(NUM_APs_IN_SIM_AREA); %sweep from 10 APs to 40 APs in the sim area
array_spacing = 0.5;
...
avg_positioning_err_centr_rss = zeros(1,L_max);
avg_positioning_err_centr_aoa = zeros(1,L_max);
avg_positioning_err_centr_hybrid = zeros(1,L_max);
avg_positioning_err_distr_median = zeros(1,L_max);
avg_positioning_err_distr_mean = zeros(1,L_max);
avg_positioning_err_distr_zscore_tz_1 = zeros(1,L_max);
avg_positioning_err_distr_bayesian = zeros(1,L_max);
avg_positioning_err_distr_zscore_tz_1_bayesian = zeros(1,L_max);

avg_err_ellipse_area_centr_rss = zeros(1,L_max);
avg_err_ellipse_area_centr_aoa = zeros(1,L_max);
avg_err_ellipse_area_centr_hybrid = zeros(1,L_max);
avg_err_ellipse_area_distr_median = zeros(1,L_max);
avg_err_ellipse_area_distr_mean = zeros(1,L_max);
avg_err_ellipse_area_distr_zscore_tz_1 = zeros(1,L_max);
avg_err_ellipse_area_distr_bayesian = zeros(1,L_max);
avg_err_ellipse_area_distr_zscore_tz_1_bayesian = zeros(1,L_max);
...
for L_idx = 1:L_max
    ...
    avg_positioning_err_centr_rss(L_idx) = mean(per_setup_positioning_err_centr_rss(:));
    avg_positioning_err_centr_aoa(L_idx) = mean(per_setup_positioning_err_centr_aoa(:));
    avg_positioning_err_centr_hybrid(L_idx) = mean(per_setup_positioning_err_centr_hybrid(:));
    avg_positioning_err_distr_median(L_idx) = mean(per_setup_positioning_err_distr_median(:));
    avg_positioning_err_distr_mean(L_idx) = mean(per_setup_positioning_err_distr_mean(:));
    avg_positioning_err_distr_zscore_tz_1(L_idx) = mean(per_setup_positioning_err_distr_zscore_tz_1(:));
    avg_positioning_err_distr_bayesian(L_idx) = mean(per_setup_positioning_err_distr_bayesian(:));
    avg_positioning_err_distr_zscore_tz_1_bayesian(L_idx) = mean(per_setup_positioning_err_distr_zscore_tz_1_bayesian(:));

    avg_err_ellipse_area_centr_rss(L_idx) = mean(per_setup_err_ellipse_area_centr_rss(:));
    avg_err_ellipse_area_centr_aoa(L_idx) = mean(per_setup_err_ellipse_area_centr_aoa(:));
    avg_err_ellipse_area_centr_hybrid(L_idx) = mean(per_setup_err_ellipse_area_centr_hybrid(:));
    avg_err_ellipse_area_distr_median(L_idx) = mean(per_setup_err_ellipse_area_distr_median(:));
    avg_err_ellipse_area_distr_mean(L_idx) = mean(per_setup_err_ellipse_area_distr_mean(:));
    avg_err_ellipse_area_distr_zscore_tz_1(L_idx) = mean(per_setup_err_ellipse_area_distr_zscore_tz_1(:));
    avg_err_ellipse_area_distr_bayesian(L_idx) = mean(per_setup_err_ellipse_area_distr_bayesian(:));
    avg_err_ellipse_area_distr_zscore_tz_1_bayesian(L_idx) = mean(per_setup_err_ellipse_area_distr_zscore_tz_1_bayesian(:));

fprintf("centr rss : %f\n", avg_positioning_err_centr_rss(L_idx));
fprintf("centr aoa : %f\n", avg_positioning_err_centr_aoa(L_idx));
fprintf("centr hybrid : %f\n", avg_positioning_err_centr_hybrid(L_idx));
fprintf("distr median : %f\n", avg_positioning_err_distr_median(L_idx));
fprintf("distr mean : %f\n", avg_positioning_err_distr_mean(L_idx));
fprintf("distr zscore tz 1 : %f\n", avg_positioning_err_distr_zscore_tz_1(L_idx));
fprintf("distr bayesian : %f\n", avg_positioning_err_distr_bayesian(L_idx));
fprintf("distr zscore tz 1 bayesian: %f\n", avg_positioning_err_distr_zscore_tz_1_bayesian(L_idx));

fprintf("err ellipse area centr rss : %f\n", avg_err_ellipse_area_centr_rss(L_idx));
fprintf("err ellipse area centr aoa : %f\n", avg_err_ellipse_area_centr_aoa(L_idx));
fprintf("err ellipse area centr hybrid : %f\n", avg_err_ellipse_area_centr_hybrid(L_idx));
fprintf("err ellipse area distr median : %f\n", avg_err_ellipse_area_distr_median(L_idx));
fprintf("err ellipse area distr mean : %f\n", avg_err_ellipse_area_distr_mean(L_idx));
fprintf("err ellipse area distr zscore tz 1 : %f\n", avg_err_ellipse_area_distr_zscore_tz_1(L_idx));
fprintf("err ellipse area distr bayesian : %f\n", avg_err_ellipse_area_distr_bayesian(L_idx));
fprintf("err ellipse area distr zscore tz 1 bayesian : %f\n", avg_err_ellipse_area_distr_zscore_tz_1_bayesian(L_idx));
