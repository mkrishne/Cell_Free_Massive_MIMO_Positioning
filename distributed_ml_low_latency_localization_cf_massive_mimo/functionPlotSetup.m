function functionPlotSetup(squareLength, RP_positions, AP_positions, TP_positions)
    ...
    filename = sprintf('PositioningSimulationSetup_%03d', figCount); % %03d pads the number with zeros
    exportgraphics(gcf, [filename, '.png'], 'Resolution', 300); % Save as PNG with 300 DPI resolution
